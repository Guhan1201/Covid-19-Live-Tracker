package com.example.covid_19_livetracker.adapter
...
import com.example.covid_19_livetracker.databinding.ItemCardViewBinding
...
class ItemAdapter(val clickListener: (stateDetails: Details) -> Unit = {}) :
    ...
    inner class StateViewHolder(private val binding: ItemCardViewBinding) :
